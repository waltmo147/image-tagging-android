...
//
//            //修改高度，模拟交错效果
//            viewHolder.wrapperView.getLayoutParams().height = position % 2 != 0 ? largeCardHeight : smallCardHeight;
//        }
//
//        @Override
...
//                super(itemView);
//                wrapperView = (ViewGroup) itemView.findViewById(R.id.wrapper_view);
